...
<body <?php if(!isset($is_excel)) echo 'onload="window.print()"'; ?>>
    ...
    <div class="nav-buttons no-print">
        ...
        <a href="<?= base_url('laporan/export-neraca?bulan='.$bulan.'&tahun='.$tahun) ?>" class="btn btn-excel">📊 Export Excel</a>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <br>
            <h3 style="margin: 5px 0; border: 1px solid #333; display: inline-block; padding: 5px 15px;">NERACA SALDO (TRIAL BALANCE)</h3>
            <p>Periode: <?= date('F Y', mktime(0, 0, 0, $bulan, 10, $tahun)) ?></p>
        </div>
        ...
        <div style="margin-top: 20px; font-size: 10px; color: #666; font-style: italic; text-align: center;">
            * Dicetak pada: <?= date('d F Y H:i') ?> | Sistem Informasi Akuntansi
        </div>
