    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- PERBAIKAN: Menggunakan UI Avatars untuk inisial nama -->
                <!-- background=random agar warnanya beda-beda tiap user -->
                <?php 
                    $nama = session()->get('nama_lengkap') ?? 'User';
                    $foto_profil = "https://ui-avatars.com/api/?name=" . urlencode($nama) . "&background=4e73df&color=ffffff&size=128&bold=true";
                ?>
