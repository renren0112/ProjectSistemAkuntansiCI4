...
<div class="card shadow mb-4 border-left-primary">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-file-signature mr-1"></i> Form Jurnal Umum</h6>
    </div>
    <div class="card-body">
        ...
        <form action="<?= base_url('transaksi/store') ?>" method="post" id="formJurnal">
            <?= csrf_field() ?>
            <input type="hidden" name="jenis_transaksi" value="Umum">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="font-weight-bold text-gray-700">Keterangan / Uraian</label>
                        <input type="text" name="keterangan" class="form-control" placeholder="Contoh: Setoran modal awal, Pembayaran beban listrik, dll..." required>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-primary px-5 shadow font-weight-bold" id="btnSimpan" disabled>
...
<script>
    ...
    document.getElementById('tableDetail').addEventListener('click', function(e) {
        if (e.target.closest('.btn-hapus')) {
            ...
            if (rowCount > 2) { // Sisakan minimal 2 baris
    ...
    function hitungTotal() {
        ...
        // Tampilkan Format Rupiah di Footer
        ...
        // Logic Balance (Toleransi koma < 1)
