...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Input Penerimaan Kas</h1>
...
<div class="card shadow mb-4 border-left-success">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="fas fa-hand-holding-usd mr-1"></i> Form Penerimaan Kas (Bukti Kas Masuk)</h6>
    </div>
    <div class="card-body">
        ...
        <form action="<?= base_url('transaksi/store') ?>" method="post" id="formPenerimaan">
            <?= csrf_field() ?>
            <input type="hidden" name="jenis_transaksi" value="PenerimaanKas">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" class="form-control" placeholder="Contoh: Penerimaan piutang dari Bapak Budi..." required>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-success py-2 small" style="background-color: #d4edda; border-color: #c3e6cb; color: #155724;">
                ...
                Masukkan <b>Akun Kas/Bank (Debit)</b> di baris pertama, dan <b>Sumber Pendapatan/Piutang (Kredit)</b> di baris kedua.
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="tableDetail">
                    ...
                    <tbody>
                        ...
                        <!-- BARIS 2: KREDIT (PENDAPATAN/PIUTANG) -->
                        <tr>
                            <td>
                                <select name="kode_akun[]" class="form-control select-akun" required>
                                    <option value="">-- Pilih Sumber Penerimaan --</option>
                                    <?php foreach($all_akun as $a): ?>
                                        <!-- Filter sederhana: biasanya Kredit adalah Pendapatan, Piutang (Aset berkurang), atau Modal -->
                                        <option value="<?= $a['kode_akun'] ?>"><?= $a['kode_akun'] ?> - <?= $a['nama_akun'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
